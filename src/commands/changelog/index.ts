...
const AREA_FLAG_DESC =
  "Technical layer: frontend|backend|cli|database|cicd (repo granularity goes in --repo, not here). This is different from `ib dev feedback --scope`, which names the product surface; ops/workspace/jerry/security are scopes, not areas.";
const AREA_SCOPE_REMEDIES: Record<string, string> = {
