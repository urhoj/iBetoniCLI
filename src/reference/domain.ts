...
export const DOMAIN_BLURBS: Record<string, string> = {
  ...
  palkki: "Day-grid bars (palkit) per vehicle-day — list/get/create/update/delete — and their type catalogue (`palkki type`: colour, vehicle-blocking, report visibility).",
  stats:
