...
export const SALES_SPECS: CommandSpec[] = [
  {
    ...
    flags: [
      ...
      { name: "search", type: "string", description: "Case-insensitive substring over companyName + asiakasNimi + ytunnus + region (union of the Myynti UI's fields and this command's, fb#817), plus the UI's joined \"companyName asiakasNimi\" string so a needle spanning that boundary matches too (fb#920). The needle is trimmed before matching (fb#856)." },
