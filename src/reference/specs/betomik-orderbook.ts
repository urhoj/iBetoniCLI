...
export const BETOMIK_ORDERBOOK_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      { name: "digest", type: "boolean", description: "Include a digest summary of what was/would be written" },
    ],
    args: [],
  ...
  },
  {
    ...
    description: "Sync audit trail (GET /api/betomik-orderbook/audit) — one row per entity a sync run wrote or digested (keikka/palkki), newest first; --since narrows to entities created at/after that ISO timestamp.",
    tier: "developer",
    auth: "any",
