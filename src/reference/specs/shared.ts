...
// ─── ERRORS ordering convention (fb#900) ─────────────────────────────────────
// Pick based on where this command's custom rows (403/404/…) belong relative
// to the universal 401/500 pair — do NOT mechanically unify existing specs
// onto one idiom, since that reorders the ERRORS block in --help (and the
// help snapshots) for every spec it touches.
