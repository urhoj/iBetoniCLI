...
export const COMMAND_DETAILS: Record<string, string> = {
  "ib keikka latest":
    "Keikka = yksi betonin toimitus-/pumppauskeikka — the central delivery/pump job. " +
  ...
  "ib jerry check-address":
    "BetoniJerry = RFQ marketplace for concrete pumping: a customer posts a tarjouspyyntö " +
  ...
  "ib keikka list":
    "Keikka = one concrete delivery/pumping job (tilaus) scheduled to a worksite. Each keikka " +
  ...
  "ib worksite search":
    "Työmaa = a named delivery destination (construction site/address) owned by a company: up to four " +
  ...
  "ib stats":
    "Aggregates delivery stats (m³ volume, order counts, active vehicles/drivers) for a period via " +
