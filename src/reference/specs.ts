...
const BASE_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    examples: ['ib glossary set valumassa --definition "Pumpattava betonimassa." --synonyms "massaa,valua" --related "ib keikka" --reason "groom"', 'ib glossary set pumppari --definition "Updated def." --update-only --reason "groom"', 'ib glossary set loma --from-json loma.json --reason "groom"'],
  },
  {
