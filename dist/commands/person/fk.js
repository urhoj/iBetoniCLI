...
import { fetchFkSources, normKey, pickFkSource, registerFkSourcesLeaf, resolveOwner, sourceNameOf, } from "../_shared/foreignKeys.js";
        ...
        for (const r of rows) {
            try {
                ...
                if (res.action === "inserted") {
                    ...
                    if (row) {
                        row.isDisabled = r.disabled;
                        if (r.text !== undefined)
                            row.foreignKeyText = r.text;
                    }
                }
