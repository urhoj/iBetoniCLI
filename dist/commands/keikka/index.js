...
export async function runKeikkaUpdate(client, keikkaId, fields, flags) {
    ...
    if (isMove) {
        ...
        if (needsRow) {
            ...
            const cur = (await runKeikkaGet(client, keikkaId));
            ...
            if (fields.end !== undefined)
                body.pumppuKesto = minutesBetween(start, fields.end, "--end");
        }
        return client.post(`/api/cli/keikka/move/${keikkaId}`, body, { headers: writeFlagsToHeaders(flags) });
    }
