...
export function formatHelp(spec) {
    ...
    lines.push("  --endpoint URL  --request-id ID  --quiet  --verbose  --pretty  --json  --read-only  --company ID  --stats  --columns CSV");
    ...
    lines.push("  --company runs ONE command as another company (ephemeral, not persisted) · ib help multi-tenancy");
    lines.push("");
