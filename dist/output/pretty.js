 ...
 */
function fittedOptions(colWidths) {
...
function envelopeContextLine(envelope) {
    const extras = Object.entries(envelope).filter(([k, v]) => !ENVELOPE_OWN_KEYS.has(k) && v != null && typeof v !== "object");
    if (extras.length === 0)
        return null;
