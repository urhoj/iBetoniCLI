...
export const COMMAND_SUMMARIES = {
    ...
    "ib attachment delete": "Soft-delete the row + IRREVERSIBLY hard-delete the Azure blob. Manager role.",
    "ib attachment detach": "Unlink an attachment from one entity (NULLs that FK). Manager role.",
    "ib attachment download": "Download attachment bytes to LOCAL disk. Local-only (denied on exec/MCP).",
    ...
    "ib attachment upload": "Upload a LOCAL file and link it to one entity. Local-only (denied on exec/MCP).",
    ...
    "ib bug admin update": "Triage a bug report: status/priority/notes/resolution/assignee. Developer-only.",
    ...
    // ── commands / discovery ──────────────────────────────────────────────────
    "ib commands": "Offline command discovery: domain index, a domain's list, or --all flat list. No auth.",
    "ib reference dump": "Emit the full command surface as JSON for AI ingestion; a domain arg narrows it.",
    // ── company ─────────────────────────────────────────────────────────────
    ...
    "ib customer create-or-update": "Upsert a customer keyed by yTunnus (idempotent onboarding). Alias: upsert.",
    ...
    "ib customer settings": "Report or toggle ALL asiakasSettings + pumppu. Superset of customer modules.",
    ...
    // ── feedback ──────────────────────────────────────────────────────────────
    "ib feedback create": "File a CLI improvement/trouble report PROACTIVELY on any friction; quiet, works under --read-only.",
    ...
    // ── jerry ───────────────────────────────────────────────────────────────
    "ib jerry admin detail": "Company Jerry drill-down: people/vehicles/sijainti enrolment. System-admin.",
    ...
    "ib jerry check-address": "Geofence probe: which provider varikot cover an address. Best tool for 'no offers'.",
    ...
    "ib jerry offer create": "Create/update YOUR draft offer on a request (provider only); send to make it visible.",
    ...
    "ib jerry provider-settings set": "Upsert a provider's Jerry settings (partial-safe). Returns the full saved row.",
    ...
    "ib legal delete": "Soft-delete (status='deleted') a doc version. Developer-only.",
    "ib legal diff": "Line diff of two doc versions (or a type's draft vs active) — full bodies stay out of context.",
    "ib legal drafts": "Unpublished drafts across all types — the draft counterpart of `active`.",
    ...
    // ── log ─────────────────────────────────────────────────────────────────
    "ib log by-entity-date": "Changes affecting deliveries DATED in a window (grid Muutoshistoria). Admin.",
    ...
    // ── message support ─────────────────────────────────────────────────────
    "ib message support contact": "Open/append a support thread escalating a tarjous or keikka. Any user.",
    ...
    "ib person create": "Create a person (--first/--last required, email optional). Supports --get-or-create and --global.",
    ...
    "ib person role explain": "Explain a role name: typeId, access tiers, deprecation + live DB description.",
    ...
    "ib person search": "Free-text search persons by name/email; --my-companies spans every company you belong to.",
    // ── schedule ──────────────────────────────────────────────────────────────
    "ib schedule today": "List today's keikkas (wrapper for keikka list --from/--to today).",
    // ── schema (developer-only) ────────────────────────────────────────────────
    "ib schema dump": "Whole-schema structural map of dbo (tables/FKs/views/procs, no bodies). Developer-only.",
    ...
    // ── search ────────────────────────────────────────────────────────────────
    "ib search": "Cross-entity unified search (customers/worksites/persons/vehicles/keikkas/sijainnit).",
    // ── sijainti ──────────────────────────────────────────────────────────────
    ...
    "ib vehicle visits": "Your fleet's visits to a worksite/sijainti (arrival/departure/duration).",
    // ── version ───────────────────────────────────────────────────────────────
