...
const BASE_COMMAND_SPECS = [
    ...
    },
    {
        ...
        description: "Change-tracker audit trail for one vehicle — who changed which field, when, old→new, with --reason. Alias of `ib log entity vehicle`. For DRIVER-assignment history use `ib vehicle drivers` (different data: personPvm assignments). GET /api/changes/vehicle/:vehicleId/:ownerAsiakasId.",
        auth: "any",
        args: [{ name: "vehicleId", type: "number", description: "vehicleId" }],
        flags: [
            { name: "owner", type: "number", description: "ownerAsiakasId (default: active company)" },
    ...
    // ─── jerry (17) — BetoniJerry marketplace ──────────────────────────────────
    {
        ...
        outputShape: "ListEnvelope<{ pumppuRequestId, status, createdAt, sentAt?, osoite, formattedAddress, totalM3|maaraM3, ... }> (fields differ between --mine and --open; --open is PII-masked; --open --all adds distanceKm/isOutOfArea/isNoSupply)",
        errors: [
