...
export const COMMAND_SPECS = [
    ...
    },
    {
        ...
        description: "Explain a role NAME offline (from @ibetoni/constants): its asiakasPersonSettingTypeId, human display name, the access tiers it grants (anyAdmin/anyWorker/anyViewer/laskuRead/requestOffer/adminCompanySelection), and whether it is deprecated. No network or auth — pure constants lookup. Use it to disambiguate the role names accepted by `person role grant/revoke` and `customer person list --role`.",
        flags: [
