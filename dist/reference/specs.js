...
const BASE_COMMAND_SPECS = [
    ...
    // ─── opendata (9): free/open external data — building + weather + prh ─────
    {
        ...
        outputShape: "{ source:'sijainti'|'worksite'|'address'|'coords', input, coords:{lat,lng}, city|null, requestedCity|null, derivedCity|null, found:boolean, outOfArea:boolean, building:{ buildingId, nationalBuildingId, buildingType, floors, totalArea, completionYear, facadeMaterial, … common schema }|null }",
        errors: [
