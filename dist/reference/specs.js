...
export const COMMAND_SPECS = [
    ...
    },
    {
        ...
        outputShape: "{ asiakasId, name, yTunnus, type, address, city, email, phone, contactPersonId, shortName, comment }",
        errors: [
    ...
    },
    {
        ...
        description: "Create a customer. Typed flags assemble the createY body (yTunnus REQUIRED); --from-prh prefills name+yTunnus from the PRH registry; --body raw JSON overrides flags. Returns the flat customer shape via re-fetch.",
    ...
    },
    {
        ...
        description: "Update a customer via read-merge-write: reads the current record, overlays the provided flags (preserving everything else — no contact-person clobber), writes back with saveGlobalAsiakas. --body raw JSON overrides flags.",
        permissions: ["auth.page.asiakas.edit"],
        flags: [
    ...
    },
    {
        ...
        outputShape: "ListEnvelope<{ changeId, field, oldValue, newValue, changeType, personId, personName, at, description }>",
        errors: permErrors("auth.page.asiakas.read"),
    ...
    },
    {
        ...
        description: "Create a new sijainti (POST /api/geocode/sijainti/add). Provide typed flags (--name/--address/--type/--lat/--lng) or --body JSON; typed flags win over --body.",
