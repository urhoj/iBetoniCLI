...
export const COMMAND_SPECS = [
    ...
    // not; the per-command help/description below is the authoritative contract.
    {
        ...
        description: "File a CLI improvement proposal or trouble report. Stored SILENTLY server-side (no GitHub issue, no email, no notification — distinct from bug reports) for later developer triage. Sent as a META request, so it is EXEMPT from the read-only write-lock: you can file feedback even with --read-only / IB_READ_ONLY active. --dry-run resolves client-side (prints the payload, never sends).",
        flags: [
