 ...
 */
const DUMP_LIMIT_BYTES = 701_000; // 700,000 -> 701,000: new `ib keikka copy` spec (700,612 B measured), trimmed twice first (notes cut from 3 bullets to 2, one example dropped, error remedies shortened) before reaching for this bump — the dump was already within ~100 B of the prior cap so any new command needed one.
